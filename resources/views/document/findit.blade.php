...
<div class="col-md-10">
<h1><span class="badge rounded-pill text-white bg-dark ">Résultat de recherche</span></h1>
<br class="my-4">
...
{
  var x = confirm("Are you sure? Deleting a player will also delete all tasks associated.");
  if (x)
      return true;
  else
    return false;
